 ...
 */
export declare function getInputChannel(entity: EntityLike): Api.TypeInputPeer | Api.InputChannel | Api.TypePeer | Entity | import("./define").FullEntity;
/**
...
export declare function getPeer(peer: EntityLike): Api.TypeInputPeer | Api.TypePeer | Entity | import("./define").FullEntity;
