...
export declare class TelegramClient extends TelegramBaseClient {
     ...
     * ```
     */
    inlineQuery(bot: EntityLike, query: string, entity?: Api.InputPeerSelf, offset?: string, geoPoint?: Api.GeoPoint): Promise<import("../tl/custom/inlineResults").InlineResults>;
    /**
     ...
     * ```
     */
    downloadMedia(messageOrMedia: Api.Message | Api.TypeMessageMedia | Message, downloadParams: DownloadMediaInterface): Promise<Buffer>;
    /**
     ...
     * ```
     */
    iterMessages(entity: EntityLike | undefined, iterParams: messageMethods.IterMessagesParams): messageMethods._MessagesIter | messageMethods._IDsIter;
    /**
     ...
     * ```
     */
    getMessages(entity: EntityLike | undefined, getMessagesParams: messageMethods.IterMessagesParams): Promise<import("../Helpers").TotalList<Message>>;
    /**
     ...
     * ```
     */
    sendMessage(entity: EntityLike, sendMessageParams: messageMethods.SendMessageParams): Promise<Message>;
    /**
     ...
     * ```
     */
    forwardMessages(entity: EntityLike, forwardMessagesParams: messageMethods.ForwardMessagesParams): Promise<Message[]>;
    /**
     ...
     *  ```
     */
    editMessage(entity: EntityLike, editMessageParams: messageMethods.EditMessageParams): Promise<Message>;
    /**
     ...
     *  }))
     ```
     */
    sendFile(entity: EntityLike, sendFileParams: uploadMethods.SendFileInterface): Promise<Message>;
    /**
    ...
    /** @hidden */
    _createExportedSender(dcId: number, retries: number): Promise<MTProtoSender>;
    /**
    ...
    /** @hidden */
    _getResponseMessage(req: any, result: any, inputChat: any): Api.TypeMessage | Message | Map<number, Message> | Message[] | undefined;
    /** @hidden */
    [inspect.custom](): {
        [key: string]: any;
    };
