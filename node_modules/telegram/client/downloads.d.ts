...
/** @hidden */
export declare function downloadMedia(client: TelegramClient, messageOrMedia: Api.Message | Api.TypeMessageMedia | Message, downloadParams: DownloadMediaInterface): Promise<Buffer>;
