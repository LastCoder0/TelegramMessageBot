...
export declare class Message extends Message_base {
    ...
    constructor({ id, peerId, date, out, mentioned, mediaUnread, silent, post, fromId, replyTo, message, fwdFrom, viaBotId, media, replyMarkup, entities, views, editDate, postAuthor, groupedId, fromScheduled, legacy, editHide, pinned, restrictionReason, forwards, replies, action, ttlPeriod, _entities, }: MessageBaseInterface);
    ...
    get toId(): Api.TypePeer | undefined;
    getEntitiesText(cls?: Function): any;
    getReplyMessage(): Promise<Message | undefined>;
    respond(params: SendMessageParams): Promise<Message | undefined>;
    reply(params: SendMessageParams): Promise<Message | undefined>;
    forwardTo(entity: EntityLike): Promise<Message[] | undefined>;
    edit(params: Omit<EditMessageParams, "message">): Promise<Message | undefined>;
    delete({ revoke }: {
        revoke?: boolean | undefined;
    }): Promise<Api.messages.AffectedMessages[] | undefined>;
    downloadMedia(params: DownloadFileParams): Promise<Buffer | undefined>;
